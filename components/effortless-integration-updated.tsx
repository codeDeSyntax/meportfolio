...
const EffortlessIntegration: React.FC<EffortlessIntegrationProps> = ({
  ...
  const orbitNodes: Array<{
  ...
  }> = [
    {
      ...
      bg: "#EFFBFF",
      icon: (
        <FaReact style={{ width: "18px", height: "18px", color: "#61DAFB" }} />
      ),
    },
    {
      label: "Next.js",
    ...
    },
    {
      ...
      icon: (
        <SiTypescript
          style={{ width: "16px", height: "16px", color: "#3178C6" }}
        />
      ),
    },
    {
      ...
      icon: (
        <SiPostgresql
          style={{ width: "17px", height: "17px", color: "#336791" }}
        />
      ),
    },
    {
      ...
      icon: (
        <SiMongodb
          style={{ width: "16px", height: "16px", color: "#47A248" }}
        />
      ),
    },
    {
      ...
      bg: "#EEF8F1",
      icon: (
        <FaNodeJs style={{ width: "18px", height: "18px", color: "#68A063" }} />
      ),
    },
    {
      label: "Express",
      ...
      icon: (
        <SiExpress
          style={{ width: "16px", height: "16px", color: "#111111" }}
        />
      ),
    },
  ];
  ...
  return (
    ...
    >
      ...
      {/* Stack icons positioned systematically on ring axes */}
      <div
        style={{
          width: "500px",
          height: "358px",
      ...
      >
        ...
        {orbitNodes.map((node) => {
          const position = getPositionOnRing(node.radius, node.angle);
