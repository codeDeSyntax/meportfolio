...
export default function PortfolioTestimonialsSection() {
  ...
  const testimonials = [
    {
      quote:
        "Josiah helped us ship cleaner UI faster than expected. His attention to detail and component quality made collaboration effortless.",
      name: "Product Lead",
      company: "Client Team",
      image:
    ...
    {
      quote:
        "From interface decisions to implementation, he translated product intent into a polished build with impressive speed.",
    ...
    {
      quote:
        "Reliable communication, thoughtful problem solving, and production-ready code. A strong engineer to have on your product team.",
      ...
      <div className="self-stretch px-2 overflow-hidden flex justify-start items-center bg-background border border-b border-l-0 border-r-0 border-t-0">
        <div className="flex-1 py-16 md:py-17 flex flex-col md:flex-row justify-center items-end gap-6">
          <div className="self-stretch px-3 md:px-12 justify-center items-start gap-4 flex flex-col md:flex-row">
            ...
            />
            <div className="flex-1 px-6 py-6 shadow-none pb-0 pt-0">
              <div
                className="self-stretch justify-start flex flex-col text-[#49423D] text-2xl md:text-[32px] font-medium leading-10 md:leading-10.5 font-sans h-50 md:h-52.5 overflow-hidden line-clamp-5 transition-all duration-700 ease-in-out tracking-tight"
                style={{
              ...
              >
                <div className="self-stretch justify-center flex flex-col text-[rgba(73,66,61,0.90)] text-lg font-medium leading-6.5 font-sans">
                  {testimonials[activeTestimonial].name}
                </div>
                <div className="self-stretch justify-center flex flex-col text-[rgba(73,66,61,0.70)] text-lg font-medium leading-6.5 font-sans">
